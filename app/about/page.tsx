...
export const metadata: Metadata = {
  title: "About - Mojoday",
  description: "Mojoday는 여행 유튜브 영상을 AI로 분석해 나만의 여행 계획을 자동으로 만들어주는 서비스입니다.",
      ...
      <main className="flex-1">
        ...
        <section className="py-20 md:py-28 text-center border-b">
          <div className="container mx-auto px-4 md:px-6 max-w-3xl space-y-6">
            <Link href="/" className="inline-flex items-center gap-2 font-bold text-2xl tracking-tighter mb-4">
              <Image src="/icon.png" alt="Mojoday" width={36} height={36} className="rounded-lg" />
              <span>Mojoday</span>
            </Link>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Mojoday는 여행 유튜브 영상을 AI로 분석해<br />
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  수많은 여행 유튜버들이 직접 발로 뛰며 쌓은 노하우와 경험이 영상 속에 담겨 있습니다.
                  Mojoday는 그 소중한 정보를 AI 기술로 추출해 누구나 쉽게 활용할 수 있는 여행 계획으로 변환합니다.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  더 이상 여행 계획에 며칠씩 시간을 쏟지 않아도 됩니다. 원하는 영상 URL 하나로 일정, 맛집, 숙소, 교통, 예산까지 한 번에 완성하세요.
                </p>
              </div>
              <div className="bg-muted rounded-2xl p-8 text-center space-y-6">
                <div className="text-5xl font-bold text-primary">1분</div>
                <p className="text-muted-foreground">유튜브 URL 입력 후<br />여행 계획 완성까지</p>
                <div className="h-px bg-border" />
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div>
                    <div className="text-2xl font-bold">33+</div>
                    <div className="text-xs text-muted-foreground mt-1">분석 가능 항목</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold">100%</div>
                    <div className="text-xs text-muted-foreground mt-1">편집 가능</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-muted/30 border-y">
          <div className="container mx-auto px-4 md:px-6 max-w-5xl">
            <h2 className="text-2xl font-bold text-center mb-12">Mojoday가 하는 일</h2>
            <div className="grid md:grid-cols-3 gap-6">
              {values.map(({ emoji, title, desc }) => (
                <div key={title} className="bg-background rounded-2xl p-6 space-y-3 border">
        ...
        <section className="py-16 text-center">
          <div className="container mx-auto px-4 md:px-6 space-y-6">
            ...
            <p className="text-muted-foreground">좋아하는 여행 유튜버의 영상 URL을 붙여넣어보세요.</p>
            <Link
              href="/"
